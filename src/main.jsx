...
Suas doações mantêm nossas atividades acessíveis para quem precisa e, mais do que isso, alimentam a esperança, a alegria e a força dos nossos associados para seguir em frente. Cada gesto de solidariedade nos ajuda a ampliar nossa rede de apoio e cuidar de quem convive com a doença de Parkinson.

Se preferir, você pode fazer uma doação de qualquer valor por meio de:
...
const partnerText = `Junte-se à Associação de Parkinson de Pernambuco (ASP-PE) e faça parte de uma comunidade que apoia pessoas com Doença de Parkinson e seus familiares. Ao se tornar um associado, você terá acesso a atividades, orientação profissional e um espaço de troca de experiências.

  Como se associar  
  1. Apresentar um atestado médico que comprove o diagnóstico de Parkinson.  
  2. Realizar o cadastro presencialmente na sede da associação.

  Valor da mensalidade  
  R$ 60,00 por mês, que contribui para a manutenção das atividades da associação.
...
const volunteerText = `🌟 Quer fazer a diferença na vida de quem vive com Parkinson?
  ...
  Junte-se à Associação de Parkinson de Pernambuco e faça a diferença na vida de quem vive com Parkinson. Ao se tornar voluntário, você fortalece a rede de apoio e contribui diretamente para a melhoria da qualidade de vida dos pacientes e familiares.
